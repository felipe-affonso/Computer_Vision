...
def main():
    ...
    if escolha == 'Filtros':
    	...
    	st.markdown("Este projeto foi desenvolvido por Felipe Affonso.")
    	st.markdown("Veja o código fonte clicando [aqui](https://github.com/felipe-affonso/Computer_Vision/tree/master/StreamLit_OpenCV_Operations)")
    	st.markdown("Entre no meu github e acompanhe outros projetos que estou desenvolvendo.")
